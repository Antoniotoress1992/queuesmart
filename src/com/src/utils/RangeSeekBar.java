...
import com.src.queuesmart.R;
import com.src.queuesmart.SearchActivity;
...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private final Bitmap thumbImage = BitmapFactory.decodeResource(getResources(), R.drawable.seek_thumb_normal_img);
    private final Bitmap thumbPressedImage = BitmapFactory.decodeResource(getResources(),
                                                                          R.drawable.seek_thumb_pressed_img);
    private final Bitmap thumbDisabledImage = BitmapFactory.decodeResource(getResources(),
                                                                           R.drawable.seek_thumb_disabled_img);
    ...
    public RangeSeekBar(Context context ,FragmentActivity parent){
    	 super(context);
         init(context, null);
         parentActivity = (SearchActivity) parent; 
    }
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        if (!selectedValuesAreDefault) {
            ...
            if (!mSingleThumb) {
            	...
            	parentActivity.setTextMin(minText);

            }
            	parentActivity.setTextMax(maxText);
